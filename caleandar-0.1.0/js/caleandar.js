        ...
        for (var i = 0; i < calendar.Selected.Days; i++) {
            ...
            for (var n = 0; n < calendar.Model.length; n++) {
                ...
                if (evDate.getTime() == toDate.getTime()) {
                    ...
                    title.innerHTML += `
                    <details>
                    <summary class="eventTitle ${calendar.Model[n].Type} button">
                    <strong>${calendar.Model[n].Title}</strong> ${calendar.Model[n].Time}&nbsp;&#8209;&nbsp;${calendar.Model[n].T_end}
                    </summary>
